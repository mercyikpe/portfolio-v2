...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button target="_blank" href="https://drive.google.com/file/d/1D1ESXhmIp5QUkLprrFdHVHRzywkLvyFH/view?usp=sharing"  variant="secondary" className="group mt-6 w-full">
        View CV
